  ...
  const messages = {
    ...
    ko: {
      ...
      support: {
        ...
        title: "피드백, FAQ, 연락처",
        lead:
          "인식 오류, 모델 다운로드 실패, 단축어 문제, 가져오기 오류 또는 기타 사용 중 문제가 있다면 아래 안내를 확인하거나 직접 연락해 주세요.",
        contactTitle: "이메일",
        ...
        faq2: "<strong>일부 스크린샷이 완전히 인식되지 않는 이유는?</strong><br>결제 화면, 영수증 형식, 스크린샷 레이아웃은 다양합니다. 인식 결과는 이미지 선명도, 정보의 완전성, 화면 구성에 영향을 받을 수 있습니다.",
        faq3: "<strong>단축어 실행 후 결과가 보이지 않으면?</strong><br>단축어 권한이 올바르게 설정되어 있는지, 앱의 초기 설정과 필요한 권한 설정이 완료되었는지 확인해 주세요.",
        modelTitle: "모델 및 다운로드",
        model1: "<strong>로컬 모델 다운로드에 실패하면?</strong><br>네트워크 연결, 저장 공간, 현재 버전의 기능 지원 여부를 확인한 뒤 다시 시도해 주세요.",
        model2: "<strong>모델을 삭제하면 어떻게 되나요?</strong><br>기본 기능은 계속 사용할 수 있지만 관련 로컬 지능 기능은 모델을 다시 다운로드할 때까지 제한될 수 있습니다.",
        ...
        feedback4: "스크린샷, 카메라, 클립보드, 단축어 중 어떤 방식으로 실행했는지",
        feedback5: "가능하다면 개인정보를 가린 화면 캡처",
        privacyTitle: "개인정보",
        privacyBody: "AutoLedger는 로컬 처리를 중심으로 설계되어 기기 안에서 기록을 인식하고 정리하도록 돕습니다.",
      },
      privacy: null,
    },
  };
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "현재 버전은 App Store Server Notifications로 구독 생명주기 이벤트를 능동 수신하지 않습니다. 향후 추가하더라도 동일한 최소화 및 해시 원칙을 따릅니다",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          "전용 지원 채널이나 피드백 경로가 추가되면 이 페이지에 함께 업데이트합니다.",
        ],
      },
    ],
  };
