  ...
  const messages = {
    "zh-Hans": {
      ...
      support: {
        ...
        lead:
          "如果你在使用 AutoLedger 时遇到识别、导入、iCloud 同步、Pro 云收件箱或快捷指令问题，可以先查看下方说明，也可以直接联系我们。",
        contactTitle: "联系邮箱",
        contactBody: "如需反馈问题、提交建议或说明审核测试情况，请通过邮箱联系：",
        faqTitle: "常见问题",
        faq1: "<strong>识别结果不准确怎么办？</strong><br>你可以在 App 内查看并修改生成后的记录，后续也可通过分类、来源和商户别名管理进一步优化效果。",
        faq2: "<strong>为什么 iCloud 同步需要一些时间？</strong><br>同步由系统调度并可能在启动后继续进行。请保持网络可用；如出现同时修改冲突，请先确认两端内容，再选择需要保留的版本。",
        faq3: "<strong>快捷指令触发后没有看到结果？</strong><br>请确认快捷指令和分享扩展已获必要权限，并检查 App 是否已完成首次配置。",
        modelTitle: "同步、Pro 与云端能力",
        model1: "<strong>云端水单收件箱暂时不可用怎么办？</strong><br>请确认 Pro 权益和网络状态，返回 App 刷新后重试。手动导入 PDF 与本地邮箱扫描不依赖专属云收件箱。",
        model2: "<strong>本地模型下载失败怎么办？</strong><br>请检查网络连接、存储空间和当前版本支持情况；基础记账能力仍可继续使用。",
        model3: "<strong>导入后直接记账还能修改吗？</strong><br>可以。记录生成后，仍可在 App 内查看、确认和手动修正。",
        feedbackTitle: "建议反馈时提供的信息",
        feedback1: "设备型号与系统版本",
        feedback2: "App 版本号",
        feedback3: "问题发生前的操作步骤",
        feedback4: "通过截图、拍照、语音、PDF、邮箱、分享或快捷指令中的哪种方式触发",
        feedback5: "如方便，可附带脱敏后的界面截图",
        privacyTitle: "关于隐私",
        privacyBody: "AutoLedger 以本地优先为核心；iCloud、Pro 水单收件箱、Common API 与匿名诊断仅在对应功能需要时使用网络。",
      },
      privacy: {
        heading: "隐私政策",
        intro:
        ...
        sections: [
          ...
          },
          {
            ...
            list: [
              ...
              "服务端可通过 App Store Server Notifications 接收订阅生命周期事件，并只处理完成权益更新所需的签名交易状态和哈希标识",
            ],
          },
          {
          ...
          },
          {
            ...
            body: [
              ...
              '联系邮箱：<a href="mailto:support@darkrio326.top">support@darkrio326.top</a>',
            ],
          },
        ],
      },
    ...
    "zh-Hant": {
      ...
      support: {
        ...
        lead: "如果你在使用 AutoLedger 時遇到辨識、匯入、iCloud 同步、Pro 雲端收件匣或捷徑問題，可以先查看下方說明，也可以直接聯絡我們。",
        contactTitle: "聯絡信箱",
        contactBody: "如需回報問題、提交建議或說明審核測試情況，請透過信箱聯絡：",
        faqTitle: "常見問題",
        faq1: "<strong>辨識結果不準確怎麼辦？</strong><br>你可以在 App 內查看並修改生成後的記錄，後續也可透過分類、來源和商戶別名管理進一步優化效果。",
        faq2: "<strong>為什麼 iCloud 同步需要一些時間？</strong><br>同步由系統排程，並可能在啟動後繼續進行。請保持網路可用；如出現同時修改衝突，請先確認兩端內容，再選擇要保留的版本。",
        faq3: "<strong>捷徑觸發後沒有看到結果？</strong><br>請確認捷徑已正確授權，並檢查 App 是否已完成首次設定與必要權限設定。",
        modelTitle: "同步、Pro 與雲端功能",
        model1: "<strong>雲端水單收件匣暫時無法使用怎麼辦？</strong><br>請確認 Pro 權益與網路狀態，回到 App 重新整理後再試。手動匯入 PDF 與本機信箱掃描不依賴專屬雲端收件匣。",
        model2: "<strong>本機模型下載失敗怎麼辦？</strong><br>請檢查網路連線、儲存空間與目前版本支援情況；基礎記帳功能仍可繼續使用。",
        model3: "<strong>匯入後直接記帳還能修改嗎？</strong><br>可以。記錄生成後，仍可在 App 內查看、確認和手動修正。",
        feedbackTitle: "建議回報時提供的資訊",
        feedback1: "裝置型號與系統版本",
        feedback2: "App 版本號",
        feedback3: "問題發生前的操作步驟",
        feedback4: "透過截圖、拍照、語音、PDF、信箱、分享或捷徑中的哪種方式觸發",
        feedback5: "如方便，可附上脫敏後的介面截圖",
        privacyTitle: "關於隱私",
        privacyBody: "AutoLedger 以本機優先為核心；iCloud、Pro 水單收件匣、Common API 與匿名診斷僅在對應功能需要時使用網路。",
      },
      privacy: null,
    },
    en: {
      ...
      support: {
        ...
        lead:
          "If you run into recognition, import, iCloud sync, Pro cloud inbox, or Shortcut issues, check the notes below or contact us directly.",
        contactTitle: "Email",
        ...
        faq2: "<strong>Why can iCloud sync take some time?</strong><br>Sync is scheduled by the system and may continue after launch. Keep a network connection available; if a concurrent-edit conflict appears, compare both versions before choosing which one to keep.",
        ...
        modelTitle: "Sync, Pro, and cloud services",
        model1: "<strong>What if the cloud folio inbox is temporarily unavailable?</strong><br>Check your Pro entitlement and network, return to the app, refresh, and try again. Manual PDF import and local mailbox scanning do not depend on the dedicated cloud inbox.",
        model2: "<strong>What if a local model fails to download?</strong><br>Check your network, storage, and version support. Core ledger features remain available.",
        ...
        feedback4: "Whether it was triggered by screenshot, camera, voice, PDF, email, sharing, or Shortcut",
        feedback5: "A redacted screenshot if possible",
        privacyTitle: "Privacy",
        privacyBody: "AutoLedger is local-first. iCloud, the Pro folio inbox, Common API services, and anonymous diagnostics use the network only for their respective features.",
      },
      privacy: null,
    },
    ja: {
      ...
      support: {
        ...
        lead:
          "認識、取り込み、iCloud 同期、Pro クラウド受信箱、ショートカットに問題がある場合は、下記をご確認いただくか直接ご連絡ください。",
        contactTitle: "メール",
        ...
        faq2: "<strong>iCloud 同期に時間がかかるのはなぜ？</strong><br>同期はシステムが調整し、起動後も継続する場合があります。ネットワークを維持し、同時編集の競合が出た場合は両方を確認してから残す版を選んでください。",
        faq3: "<strong>ショートカット実行後に結果が出ない場合は？</strong><br>ショートカットの権限と、アプリの初期設定・必要な権限設定が完了しているか確認してください。",
        modelTitle: "同期、Pro、クラウド機能",
        model1: "<strong>クラウド明細受信箱が一時的に使えない場合は？</strong><br>Pro 権利とネットワークを確認し、App に戻って更新してから再試行してください。PDF の手動取り込みとローカルメールスキャンは専用クラウド受信箱に依存しません。",
        model2: "<strong>ローカルモデルのダウンロードに失敗する場合は？</strong><br>ネットワーク、空き容量、バージョン対応を確認してください。基本の台帳機能は引き続き利用できます。",
        ...
        feedback4: "スクリーンショット、カメラ、音声、PDF、メール、共有、ショートカットのどれで起動したか",
        feedback5: "可能であれば個人情報を隠したスクリーンショット",
        privacyTitle: "プライバシー",
        privacyBody: "AutoLedger はローカルファーストです。iCloud、Pro 明細受信箱、Common API、匿名診断は、それぞれの機能に必要な場合のみネットワークを利用します。",
      },
      privacy: null,
    },
    ko: {
      meta: {
        homeTitle: "AutoLedger - 원터치 가계부",
        homeDescription: "AutoLedger는 스크린샷과 단축어로 지출 기록을 빠르게 남기는 원터치 가계부 앱입니다.",
        supportTitle: "AutoLedger 지원",
        supportDescription: "AutoLedger 지원, 문제 해결, 자주 묻는 질문 및 연락처 안내.",
        privacyTitle: "AutoLedger 개인정보 처리방침",
        privacyDescription: "AutoLedger 개인정보 처리방침.",
      },
      nav: { home: "홈", privacy: "개인정보", support: "지원", contact: "개발자에게 문의" },
      action: {
        privacy: "개인정보 처리방침 보기",
        support: "지원",
        appStore: "App Store",
        goAppStore: "App Store 열기",
        testFlight: "TestFlight 참여",
      },
      home: {
        badge: "⚡ 원터치 기록 · 스크린샷 자동 입력",
        heroTitle: "길게 한 번 누르면,<br>기록 완료.",
        heroDesc:
          "AutoLedger는 스크린샷, 단축어, 기기 내 인식을 바탕으로 한 원터치 가계부 앱입니다. 액션 버튼을 길게 누르면 금액과 가맹점을 자동으로 읽어 기록을 만듭니다.",
        heroNote: "기록 데이터는 기본적으로 기기 안에 저장됩니다.",
        whyEyebrow: "만든 이유",
        whyTitle: "가계부를 더 편하게 쓰기보다,<br>덜 쓰게 하기 위해.",
        whyBody:
          "많은 사람이 기록을 싫어하는 것이 아니라 매번 번거로워서 미루게 됩니다. AutoLedger의 목표는 지출 기록을 아주 자연스러운 한 번의 동작으로 줄이는 것입니다.",
        quickTitle: "원터치 기록",
        quickBody: "단축어와 액션 버튼으로 기록 흐름을 바로 시작해 앱 열기, 이미지 선택, 금액 입력 같은 반복 작업을 줄입니다.",
        ocrTitle: "스크린샷 인식",
        ocrBody: "결제 스크린샷, 사진 또는 공유 콘텐츠에서 금액, 가맹점, 시간을 읽어 기록을 생성합니다.",
        localTitle: "로컬 우선",
        localBody: "기록 데이터는 기본적으로 기기에 저장됩니다. 현재 버전은 기기 내 처리를 중심으로 설계되어 불필요한 외부 전송을 줄입니다.",
        flowEyebrow: "사용 흐름",
        flowTitle: "가장 짧은 경로",
        step1Title: "평소처럼 결제",
        step1Body: "평소처럼 결제를 마칩니다. 별도로 가계부 앱을 열 필요가 없습니다.",
        step2Title: "길게 누르거나 단축어 실행",
        step2Body: "원터치 기록 진입점을 실행하고 스크린샷을 인식 흐름으로 전달합니다.",
        step3Title: "자동 인식 후 기록",
        step3Body: "AutoLedger가 금액, 가맹점, 시간, 분류를 읽고 기록 결과를 알려줍니다.",
        philosophyEyebrow: "제품 철학",
        quote: "“기록한다”는 일을<br>가능한 한 사라지게.",
        philosophyBody: "AutoLedger는 복잡한 금융 시스템이나 거대한 가계부 플랫폼을 목표로 하지 않습니다. 단 하나의 문제에 집중합니다:",
        philosophyStrong: "거의 노력 없이 모든 소비 기록을 남기는 것.",
        capabilitiesEyebrow: "현재 기능",
        capability1: "단축어 기반 원터치 기록",
        capability2: "결제 스크린샷 가져오기 및 인식",
        capability3: "카메라 인식과 클립보드 가져오기",
        capability4: "기록 목록과 기본 월간 리포트",
        capability5: "OCR 원문과 분석 결과를 확인하는 디버그 화면",
        audienceEyebrow: "이런 분에게",
        audience1: "기록은 남기고 싶지만 직접 입력은 싫은 사람",
        audience2: "iPhone 단축어와 액션 버튼을 자주 쓰는 사람",
        audience3: "일상 지출을 빠르게 남기고 싶은 사람",
        audience4: "먼저 기록하고 나중에 정리하고 싶은 사람",
        ctaEyebrow: "시작하기",
        ctaBody: "더 가볍고 빠르며 거의 의식하지 않는 기록 방식을 찾고 있다면 TestFlight에 참여하거나 개발자에게 연락해 주세요.",
      },
      support: {
        eyebrow: "AutoLedger 지원",
        title: "피드백, FAQ, 연락처",
        lead:
          "인식, 가져오기, iCloud 동기화, Pro 클라우드 받은편지함 또는 단축어에 문제가 있다면 아래 안내를 확인하거나 직접 연락해 주세요.",
        contactTitle: "이메일",
        contactBody: "버그 제보, 제안, 심사/테스트 상황 공유는 아래로 연락해 주세요:",
        faqTitle: "자주 묻는 질문",
        faq1: "<strong>인식 결과가 정확하지 않으면?</strong><br>앱 안에서 생성된 기록을 확인하고 수정할 수 있습니다. 이후 분류, 출처, 가맹점 별칭 관리로 결과를 더 개선할 수 있습니다.",
        faq2: "<strong>iCloud 동기화에 시간이 걸리는 이유는?</strong><br>동기화는 시스템이 조정하며 앱 실행 후에도 계속될 수 있습니다. 네트워크를 유지하고 동시 수정 충돌이 나타나면 두 버전을 확인한 뒤 보관할 버전을 선택하세요.",
        faq3: "<strong>단축어 실행 후 결과가 보이지 않으면?</strong><br>단축어 권한이 올바르게 설정되어 있는지, 앱의 초기 설정과 필요한 권한 설정이 완료되었는지 확인해 주세요.",
        modelTitle: "동기화, Pro 및 클라우드 기능",
        model1: "<strong>클라우드 명세서 받은편지함을 일시적으로 사용할 수 없다면?</strong><br>Pro 권한과 네트워크를 확인하고 앱으로 돌아가 새로 고친 뒤 다시 시도하세요. PDF 직접 가져오기와 로컬 메일함 스캔은 전용 클라우드 받은편지함에 의존하지 않습니다.",
        model2: "<strong>로컬 모델 다운로드에 실패하면?</strong><br>네트워크, 저장 공간, 버전 지원 여부를 확인하세요. 기본 장부 기능은 계속 사용할 수 있습니다.",
        model3: "<strong>가져온 뒤 바로 기록된 항목을 수정할 수 있나요?</strong><br>네. 생성된 기록은 앱 안에서 확인, 확정, 수동 수정할 수 있습니다.",
        feedbackTitle: "제보 시 도움이 되는 정보",
        feedback1: "기기 모델과 시스템 버전",
        feedback2: "앱 버전",
        feedback3: "문제가 발생하기 전의 조작 순서",
        feedback4: "스크린샷, 카메라, 음성, PDF, 이메일, 공유, 단축어 중 어떤 방식으로 실행했는지",
        feedback5: "가능하다면 개인정보를 가린 화면 캡처",
        privacyTitle: "개인정보",
        privacyBody: "AutoLedger는 로컬 우선으로 설계됩니다. iCloud, Pro 명세서 받은편지함, Common API, 익명 진단은 각 기능에 필요할 때만 네트워크를 사용합니다.",
      },
      privacy: null,
    },
  };
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "The server may receive subscription lifecycle events through App Store Server Notifications and processes only signed transaction status and hashed identifiers needed to update entitlements",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          'Support email: <a href="mailto:support@darkrio326.top">support@darkrio326.top</a>',
        ],
      },
    ],
  };
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "サーバーは App Store Server Notifications を通じてサブスクリプションのライフサイクルイベントを受信し、権利更新に必要な署名済み取引状態とハッシュ化識別子のみを処理する場合があります",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          'サポートメール：<a href="mailto:support@darkrio326.top">support@darkrio326.top</a>',
        ],
      },
    ],
  };
    ...
    sections: [
      {
        title: "1. 서비스 제공자",
        body: [
          "AutoLedger는 개인 사용자를 위한 지출 기록 앱입니다. 스크린샷 인식, 카메라 인식, 빠른 텍스트 입력, 호텔 명세서 가져오기, 여러 장부, 구독 관리, 월간 리포트, AutoLedger Pro 자동화 기능을 제공합니다.",
          "본 방침은 AutoLedger 앱, 관련 Apple 플랫폼 버전, getautoledger.app의 AutoLedger 관련 서비스 페이지에 적용됩니다.",
        ],
      },
      {
        title: "2. 처리하는 정보",
        body: [
          "AutoLedger는 기본적으로 계정 등록을 요구하지 않으며, 이름, 전화번호, 신분증 번호 같은 개인 식별 정보를 적극적으로 수집하지 않습니다.",
          "사용자가 선택한 기능에 따라 AutoLedger는 다음 정보를 처리할 수 있습니다.",
        ],
        list: [
          "사용자가 가져오는 스크린샷, 사진, PDF, 영수증 또는 호텔 명세서 첨부파일",
          "해당 파일에 포함될 수 있는 금액, 가맹점, 호텔명, 숙박일, 시간, 결제 수단, 통화 등의 명세 텍스트",
      ...
      {
        title: "3. 로컬 처리, iCloud 및 기기 동기화",
        body: [
          "AutoLedger는 <strong>로컬 우선</strong>으로 설계되었습니다. 기본적으로 인식, 분석, 분류, 표시, 편집은 기기에서 우선 실행되며 기록 데이터도 먼저 기기 안에 저장됩니다.",
        ],
        list: [
          "OCR, 분석, 분류, 중복 제거, 월간 리포트는 기본적으로 기기에서 실행됩니다",
          "이메일 앱 비밀번호 또는 인증 코드는 로컬 Keychain에만 저장되며 AutoLedger 서버로 업로드되지 않습니다",
          "iCloud 동기화 또는 백업을 켜면 관련 데이터는 사용자의 Apple iCloud 계정을 통해 동기화되며, 개발자는 iCloud 내용을 직접 읽을 수 없습니다",
          "동기화를 끄거나 로컬 데이터를 삭제하면 앱은 시스템 기능과 사용자의 조작에 따라 새 동기화를 중단하거나 로컬 사본을 제거합니다",
        ],
      },
      {
        title: "4. AutoLedger Pro 및 구독 확인",
        body: [
          "AutoLedger Pro는 App Store 구독으로 제공됩니다. 구매, 갱신, 환불, 청구, 결제 수단은 Apple이 처리하며 AutoLedger는 카드 번호나 전체 결제 정보를 받지 않습니다.",
          "Pro 활성 여부를 판단하기 위해 앱은 기기의 StoreKit 권한 상태를 읽습니다. 클라우드 호텔 명세서 받은편지함 같은 서버 기반 기능을 사용할 때 앱은 Apple이 서명한 거래 정보를 AutoLedger Worker로 보낼 수 있으며, Worker는 App Store Server API를 통해 상품 ID, Bundle ID, 철회 상태, 만료 시간을 확인합니다.",
        ],
        list: [
          "서버는 필요한 구독 상태, 만료 시간, 원 거래 ID에서 생성한 해시 식별자만 저장합니다",
          "Pro가 만료되어도 이미 저장한 과거 기록, 호텔 이용 내역, PDF, 기본 내보내기 기능은 계속 접근할 수 있습니다",
          "서버는 App Store Server Notifications를 통해 구독 생명주기 이벤트를 수신할 수 있으며, 권한 업데이트에 필요한 서명된 거래 상태와 해시 식별자만 처리합니다",
        ],
      },
      {
        title: "5. 로컬 이메일 스캔과 클라우드 호텔 명세서 받은편지함",
        body: [
          "AutoLedger는 두 가지 호텔 명세서 정리 방식을 제공합니다: 로컬 이메일 스캔과 AutoLedger Pro 클라우드 전용 명세서 받은편지함.",
        ],
        list: [
          "로컬 이메일 스캔은 사용자가 기기에서 설정한 메일함에 연결해 관련 호텔 명세서 메일과 첨부파일을 찾습니다. 이메일 앱 비밀번호나 인증 코드는 로컬 Keychain에만 저장되고 서버로 업로드되지 않습니다",
          "클라우드 전용 명세서 받은편지함은 folio+token@getautoledger.app 같은 전용 주소로 전달된 메일만 처리합니다. QQ, Gmail, Outlook, iCloud Mail 또는 기타 개인 메일함에 로그인하지 않습니다",
          "클라우드 Worker는 PDF 첨부파일 또는 필요한 본문 명세 내용을 추출하고, 앱이 다운로드해 검토할 수 있도록 후보 PDF와 최소화된 후보 메타데이터를 저장합니다",
          "클라우드 후보는 공식 장부에 자동으로 기록되지 않습니다. 다운로드 후에도 사용자가 앱에서 확인해야 호텔 이용 내역이나 기록이 생성됩니다",
          "APNs 알림은 일반 메시지와 deep link만 사용하며 호텔명, 금액, 주문 번호, 첨부파일명, 받은편지함 token을 포함하지 않습니다",
        ],
        warning:
          "AutoLedger가 처리하기를 원하는 호텔 명세서 메일만 전용 주소로 전달해 주세요. 전용 주소와 일치하지 않는 메일은 사용자의 호텔 명세서 후보로 처리되지 않습니다.",
      },
      {
        title: "6. 정보 이용 목적",
        body: ["관련 정보는 다음 목적에만 사용됩니다."],
        list: [
          "사용자가 가져오거나 전달한 명세서, 스크린샷, 사진, PDF 또는 호텔 명세서 내용을 인식하기 위해",
          "확인 대기 기록, 호텔 이용 내역, 구독, 월간 요약 및 관련 검토 화면을 생성하기 위해",
          "로컬 이메일 스캔, 클라우드 명세서 후보, 후보 일괄 정리, 중복 제거 및 기타 Pro 자동화 기능을 제공하기 위해",
      ...
      {
        title: "7. 권한 사용",
        body: ["사용하는 기능에 따라 AutoLedger는 다음 시스템 권한을 요청할 수 있습니다."],
        list: [
          "<strong>사진/앨범 권한</strong>: 사용자가 선택한 스크린샷이나 사진을 읽어 명세를 인식하기 위해.",
          "<strong>카메라 권한</strong>: 영수증, 명세서, 티켓 또는 결제 화면을 촬영하기 위해.",
          "<strong>마이크/음성 입력</strong>: 사용자가 음성 또는 한 문장 기록을 명시적으로 사용할 때 입력을 받기 위해.",
          "<strong>알림 권한</strong>: 기록 결과, 리마인더, 구독 알림 또는 클라우드 후보 상태를 표시하기 위해.",
          "<strong>클립보드 접근</strong>: 사용자가 붙여넣기 가져오기를 명시적으로 실행한 경우에만 텍스트나 이미지를 읽기 위해.",
          "<strong>iCloud</strong>: 동기화 또는 백업을 켠 경우 Apple iCloud를 통해 관련 데이터를 저장하고 동기화하기 위해.",
        ],
        after: ["모든 권한은 해당 기능에 필요할 때만 사용됩니다. 시스템 설정에서 언제든지 끌 수 있습니다."],
      },
      {
        title: "8. 제3자 및 인프라 서비스",
        body: [
          "AutoLedger는 가능한 한 기기 안에서 처리합니다. 사용자가 선택적으로 켠 일부 기능은 Apple, Cloudflare 또는 사용자가 설정한 외부 서비스에 의존할 수 있습니다.",
        ],
        list: [
      ...
      },
      {
        title: "9. 저장, 보관 및 삭제",
        body: [
          "로컬 기록, 호텔 이용 내역, 구독 및 설정은 사용자가 기기에서 관리합니다. 클라우드 호텔 명세서 받은편지함은 후보 다운로드와 검토를 제공하는 데 필요한 자료만 저장합니다.",
        ],
        list: [
          "로컬 데이터의 보관 기간은 사용자가 제어합니다. 앱 또는 데이터를 삭제하면 로컬 사본이 제거될 수 있습니다",
          "iCloud 데이터는 사용자의 Apple 계정과 시스템 설정에서 관리됩니다",
      ...
      },
      {
        title: "10. 데이터 보안",
        body: [
          "iOS Keychain, 시스템 권한 제어, token 해시화, 클라우드 메타데이터 최소화, 서버 측 구독 확인, 접근 token, 암호화 전송 등 합리적인 보호 조치를 사용합니다.",
          "다만 어떤 네트워크 전송이나 전자 저장 방식도 절대적인 안전을 보장할 수 없습니다. 민감한 재무 정보를 다룰 경우 가져오거나 전달하는 내용을 신중히 선택하고 앱 설정과 시스템 권한을 정기적으로 확인해 주세요.",
        ],
      },
      {
        title: "11. 아동",
        body: ["AutoLedger는 독립적인 재무 관리가 필요한 사용자를 위해 설계되었습니다. 만 14세 미만 아동에게 의도적으로 서비스를 제공하거나 개인 정보를 수집하지 않습니다."],
      },
      {
        title: "12. 사용자의 선택과 권리",
        body: ["적용 법률이 허용하는 범위에서 사용자는 다음을 할 수 있습니다."],
        list: [
          "기기에 저장된 기록과 호텔 이용 내역을 확인, 편집, 내보내기 또는 삭제",
          "사진, 카메라, 알림, 마이크, iCloud 등 시스템 권한 끄기",
          "로컬 이메일 인증 제거, 클라우드 받은편지함 주소 교체 또는 메일 전달 중단",
          "App Store를 통해 Pro 구독 관리, 취소 또는 복원",
          "관련 기능 사용 중단 또는 앱 삭제",
        ],
      },
      {
        title: "13. 처리방침의 업데이트",
        body: [
          "제품 기능, 법률 요건 또는 서비스 구성 변경에 따라 본 방침을 업데이트할 수 있습니다. 업데이트된 버전은 이 페이지에 게시되며 게시 시점부터 효력이 발생합니다.",
          "중대한 변경이 있는 경우 업데이트 설명, 앱 내 안내 또는 기타 합리적인 방법으로 알립니다.",
        ],
      },
      {
        title: "14. 문의",
        body: [
          "본 방침에 대한 질문, 제안 또는 불만이 있으면 개발자에게 연락해 주세요.",
          '웹사이트: <a href="https://getautoledger.app/" target="_blank" rel="noopener noreferrer">https://getautoledger.app/</a>',
          '지원 이메일: <a href="mailto:support@darkrio326.top">support@darkrio326.top</a>',
        ],
      },
    ],
  };
