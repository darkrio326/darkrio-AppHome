(function () {
  ...
  const messages = {
    "zh-Hans": {
      ...
      autonotice: {
        badge: "AutoNotice 0.2 · 已在 App Store 上架",
        navWeather: "天气提醒",
        navExpiry: "到期提醒",
        navHistory: "历史",
        ...
        heroNote: "0.2 已通过 Apple 审核并公开上架。无需账号，也无需公开个人资料。",
        step1Title: "设定关心的变化",
        ...
        finalTitle: "从 App Store 下载 AutoNotice 0.2。",
        finalBody: "首个公开版本已上线：天气、到期事项与 Developer Webhook，共用一套清楚的提醒体验。",
        signal1Title: "三个可用入口",
        ...
        screenshotLead: "以下界面来自当前 0.2 App Store 截图，并随简体中文或英文自动切换。",
      ...
      support: {
        ...
        version: "适用版本：0.2",
        updated: "最后更新：2026-07-20",
        contactTitle: "联系邮箱",
        contactBody: "如需反馈问题、提交建议或说明审核测试情况，请通过邮箱联系：",
        installBody: "AutoNotice 0.2 已公开上架，可以直接从 App Store 安装：",
      ...
      webhookSupport: {
        ...
        version: "适用版本：AutoNotice v0.2 App Store",
        updated: "最后更新：2026-07-20",
        boundaryTitle: "能力边界",
        ...
        locateSteps: [
          "从 App Store 安装 AutoNotice v0.2。",
          "打开 AutoNotice，进入设置。",
  ...
  -d '{
    ...
    en: {
      ...
      autonotice: {
        badge: "AutoNotice 0.2 · Available on the App Store",
        navWeather: "Weather",
        navExpiry: "Expiry",
        navHistory: "History",
        ...
        heroNote: "Version 0.2 has passed Apple review and is publicly available. No account or public profile required.",
        ...
        finalTitle: "Download AutoNotice 0.2 on the App Store.",
        finalBody: "The first public release brings weather, expiry dates, and Developer Webhook into one clear notice experience.",
        ...
        screenshotLead: "These screens come from the current 0.2 App Store listing and switch with Simplified Chinese or English.",
      ...
      support: {
        ...
        installBody: "AutoNotice 0.2 is publicly available from the App Store:",
      ...
      webhookSupport: {
        ...
        version: "Applies to: AutoNotice v0.2 App Store",
        updated: "Last updated: July 20, 2026",
        boundaryTitle: "Scope",
        ...
        locateSteps: [
          "Install AutoNotice v0.2 from the App Store.",
  ...
  function renderSupport(locale) {
    ...
    container.innerHTML = `
      <section class="doc-card">
        ...
        <p>${data.installBody}</p>
        <p><a class="contact-box" href="https://apps.apple.com/app/autonotice-%E8%87%AA%E5%8A%A8%E6%8F%90%E9%86%92/id6777452429" target="_blank" rel="noopener noreferrer">${(messages[locale] || messages["zh-Hans"]).action.appStore}</a></p>
